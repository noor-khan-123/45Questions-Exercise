...
// Travel destinations
var travelplaces = ['Paris, France', 'Rome, Italy', 'Tokyo, Japan', 'New York, USA', 'Sydney, Australia'];
...
var dinnerguestList = ['Alice', 'Bob', 'Charlie', 'David'];
console.log("You are inviting ".concat(dinnerguestList.length, " people to dinner."));
