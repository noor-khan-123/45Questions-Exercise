...
var canceledGuest = 'Charlie';
console.log("Sorry ".concat(canceledGuest, ", I heard you can't make it to dinner."));
var newGuest = 'Eve';
var indexOfCanceledGuest = guestList.indexOf(canceledGuest);
